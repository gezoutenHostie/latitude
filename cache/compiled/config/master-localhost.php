...
return [
    ...
    'timestamp' => 1528079429,
    'checksum' => 'ac1a448b27ad55c40fcabc4b64924081',
    'files' => [
        'user/config' => [
            'media' => [
    ...
    'data' => [
        'plugins' => [
            ...
            'email' => [
                'enabled' => true,
                'from' => 'noreply@latitude.com',
                'from_name' => NULL,
                'to' => 'laurens.dumon@gmail.com',
                'to_name' => NULL,
                'mailer' => [
                    'engine' => 'sendmail',
                    'smtp' => [
        ...
        'site' => [
            ...
            'metadata' => [
                'description' => 'LEADERS IN QUALITY BLOCKCHAIN SERVICES AND COMMUNITY MANAGEMENT '
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
